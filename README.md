...
手机拍照录题 → AI 识别题目（含公式与图形）→ Web 端管理 → 后续组卷导出打印、重练巩固。

## 当前进度

**已完成（第一步）**：手机拍照 → 框选单页多题 → 上传 → AI 识别文字/图形 → Web 管理端汇总查看。

后续规划：AI 生成答案、组卷导出 PDF、手机端重练自评、连对 3 次自动移出题库。
...
├── admin.html / admin.js # Web 管理端（题库查看、搜索、删除）
├── style.css
...
5. 到 Web 管理端查看全部题目，支持按文字/知识点搜索、按掌握状态筛选、删除。
